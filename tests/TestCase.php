...
abstract class TestCase extends Orchestra
{
    ...
    protected function defineEnvironment($app): void
    {
        ...
        Gate::define('escalated-agent', fn ($user) => true);
        Gate::define('escalated-admin', fn ($user) => true);
    }
     ...
     */
    protected function getFilamentPanel(): Panel
    {
    ...
    protected function resolveApplicationConfiguration($app): void
    {
        ...
        $app->afterResolving(FilamentManager::class, function (FilamentManager $filament) {
            $panel = Panel::make()
                ->default()
                ->id('admin')
                ->path('admin')
